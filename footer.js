...
<div class="footer__top-wrapper">
  <div class="foot-container">
    <div class="footer__top">
      ...
      <div class="footer__widget">
        <h3 class="footer__title" style="color:#373435">.</h3>
        <ul class="footer__menu">
...
<div class="footer__btm-wrapper">
  <div class="container">
   <div class="footer_bottom_text">
     ...
     <div class="element-box element-box-1">
     Copyright © <a href="https://${WEBSITE_LINK}" target="_blank" style="color:#f58634" onMouseOver="this.style.color='#f58634'">${
    WEBSITE_LINK.split(".")[1]
  }</a> ${cuurentYear} All Right Reserved.
    </div>

     <div class="element-box element-box-2">
     Powered By <a href="https://www.technolitics.com" target="_blank" style="color:#f58634" onMouseOver="this.style.color='#f58634'">Technolitics</a>
    </div>
